...
const DATASET_META: Record<number, {
  ...
  12: {
    ...
    kind: "image",
    question: [
      "What is the primary object in this image?",
      "Identify the main subject of this photograph:",
      "What category best describes the main element in the image?",
    ],
    options: ["vehicle", "person", "building", "animal", "nature", "food", "electronics", "clothing"],
    difficulty: "easy", pointsReward: 10,
  },
  13: {
  ...
  20: {
    name: "Image Object Classification",
    kind: "image",
    question: [
      "What is the main object in this image?",
      "Identify the primary subject:",
      "Which category best describes what you see?",
    ],
    options: ["Person", "Car", "Dog", "Cat", "Chair", "Bird", "Horse", "Bus", "Truck", "Airplane"],
    difficulty: "easy", pointsReward: 10,
  },
  21: {
    ...
    kind: "image",
    question: [
      "What facial expression does the person show?",
      "Identify the dominant emotion in this face:",
      "Which emotion best matches this expression?",
    ],
    options: ["Happy", "Sad", "Angry", "Surprised", "Fearful", "Disgusted", "Neutral"],
    difficulty: "medium", pointsReward: 20,
  },
  22: {
    ...
    kind: "image",
    question: [
      "Does this product image show any defects?",
      "Assess the quality of this product:",
      "Is this item acceptable for sale?",
    ],
    options: ["No defects", "Minor defect", "Major defect", "Reject"],
    difficulty: "medium", pointsReward: 20,
  },
  23: {
  ...
  29: {
    name: "Satellite Image Land Use",
    kind: "image",
    question: [
      "What type of land use is shown in this satellite image?",
      "Classify the terrain in this aerial photograph:",
      "What does this satellite view primarily show?",
    ],
    options: ["Urban area", "Forest", "Agricultural land", "Water body", "Desert", "Industrial zone"],
    difficulty: "medium", pointsReward: 20,
  },
};
